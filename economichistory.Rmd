...
2a-this means redoing the first dataset in income tax data, rexport should look like rexport 1 and rexport 2
3. fix stuff that is not displaying well when knit
