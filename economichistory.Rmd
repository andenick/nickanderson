...
IncomeTaxData3 <- read_excel('C:\\Users\\anden\\Dropbox\\Data Science\\web Tax Revenue Cyclicality\\IncomeTaxData_NA.xlsx', sheet="RExport2")
...
ggratio2 <- max(IncomeTaxvs$value/1000000000)/max(ITvsCol2b$value)
...
ggIncomeTaxData2 <- ggplot(ITvsCol2a,aes(x=date,y=value,fill=type)) +
                   ...
                   scale_y_continuous(name="Tax Revenue in $B",
                                      ...
                                      labels=scales::dollar_format(accuracy=.1),
                                      sec.axis =
                                      sec_axis(trans=~./max(IncomeTaxvs$value)*max(ITvsCol2b$value),
                   ...
                   scale_fill_manual(values=c("#640000", "#00B0F0",'black'),
                                     breaks=c('Income Tax Revenue','Other Tax Revenue','NGDP')) +
...
Source: Lebergott 1957 (he was with the NBER) and the BLS [Data](https://www.nickanderson.us/data.html)
