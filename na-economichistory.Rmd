...
IncomeTaxvs3$mark[1] <- IncomeTaxvs3$value[1]
IncomeTaxvs3$mark[3] <- IncomeTaxvs3$value[3]
IncomeTaxvs3$mark[5] <- IncomeTaxvs3$value[5]
IncomeTaxvs3$mark[7] <- IncomeTaxvs3$value[7]
IncomeTaxvs3$mark[9] <- IncomeTaxvs3$value[9]
IncomeTaxvs3$mark[11] <- IncomeTaxvs3$value[11]
IncomeTaxvs3$mark[13] <- IncomeTaxvs3$value[13]
IncomeTaxvs3$mark[15] <- IncomeTaxvs3$value[15]
...
ggratio1 <- (max(IncomeTaxvs$value/1000000000)+1.5)/max(IncomeTaxvs3$value)

ggIncomeTaxData <- ggplot(ITvsCol,
                   ...
                   scale_y_continuous(name="Billions of Dollars",
                                      ...
                                      sec.axis = sec_axis(trans=~./max(IncomeTaxvs$value/1000000000)*max(IncomeTaxvs3$value),
                                                          name="Unemployment",
                   ...
                   geom_label(data = IncomeTaxvs3,
                           aes(y=value*ggratio1,
                               label = mark),
                           method = 'last.points',
                           labels = scales::label_percent(accuracy = .001),
                           fill = 'white')
...
# breaks = seq(min(ITvsCol$date),max(ITvsCol$date),by='years'),
# c('','','','','','','')
# min(ITvsCol$date)
# max(ITvsCol$date) 
# 
