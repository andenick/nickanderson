...
ggTaxData1 <- ggplot(IncomeTaxData3, aes(x=date,y=value,fill=fct_reorder(type,order))) +
              ...
              theme(legend.position="bottom",
                   ...
                   scale_x_continuous(name="Years",
                                      breaks=seq(min(IncomeTaxData3$date),max(IncomeTaxData3$date),by=20),
                                      ) +
                  geom_vline(aes(xintercept=1862)) +
                  geom_vline(aes(xintercept=1913)) +
                  ...
                  scale_fill_manual(values=c("yellow",'green',"#00B0F0",'purple','#640000'))
